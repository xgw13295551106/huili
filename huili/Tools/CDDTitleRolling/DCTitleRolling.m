...
- (void)setUpRollingLeft
{
    ...
    self.leftImageView.frame = CGRectMake(0, RollingViewHeight * 0.1, RollingViewHeight * 1.8, RollingViewHeight * 0.8);
...
- (void)setUpRollingCenterRight
{
    ...
    if (_rolTitles.count > 1) {//@[@[],@[]]
        ...
        for (NSInteger i= 0; i < firstTitleArrray.count; i++) {
            ...
            UIButton *middleView = [self getBackMiddleViewWithFrame:CGRectMake(CGRectGetMaxX(self.leftImageView.frame)+10, 0, RollingViewWidth - CGRectGetMaxX(self.leftImageView.frame)-10, RollingViewHeight) WithIndex:i]; //中间View
            ...
            if (_rightImages.count == firstTitleArrray.count) {
                ...
                rightImageView.frame = CGRectMake(-10, 0, 4, 60);
