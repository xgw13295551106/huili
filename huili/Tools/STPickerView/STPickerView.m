...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        _buttonLeft = [[UIButton alloc]initWithFrame:CGRectMake(leftX, leftY+3, leftW+10, leftH-6)];
        ...
        [_buttonLeft addBorderColor:STYLECOLOR];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight addBorderColor:STYLECOLOR];
        _buttonRight.layer.borderWidth = 1.0f;
        [_buttonRight.titleLabel setFont:self.font];
        _buttonRight.backgroundColor = STYLECOLOR;
