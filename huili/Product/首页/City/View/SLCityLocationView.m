...
- (UILabel *)cityLabel {
    if (!_cityLabel) {
        ...
        _cityLabel.textColor = STYLECOLOR;
    }
    return _cityLabel;
}
...
- (UIButton *)cityButton {
    if (!_cityButton) {
        ...
        [_cityButton setTitleColor:STYLECOLOR forState:UIControlStateNormal];
        _cityButton.titleLabel.font = [UIFont systemFontOfSize:13.0];
        _cityButton.layer.borderWidth = 1;
        _cityButton.layer.borderColor = STYLECOLOR.CGColor;
...
- (UIButton *)locationButton {
    if (!_locationButton) {
        ...
        [_locationButton setTitleColor:STYLECOLOR forState:UIControlStateNormal];
